package it.lorenzoDeCarolis.GestionePrenotazioni;
...
import it.lorenzoDeCarolis.GestionePrenotazioni.config.Configuration;
import it.lorenzoDeCarolis.GestionePrenotazioni.entity.Edificio;
import it.lorenzoDeCarolis.GestionePrenotazioni.entity.Postazione;
import it.lorenzoDeCarolis.GestionePrenotazioni.entity.Prenotazione;
import it.lorenzoDeCarolis.GestionePrenotazioni.entity.Utente;
import it.lorenzoDeCarolis.GestionePrenotazioni.enums.TipoPostazione;
import it.lorenzoDeCarolis.GestionePrenotazioni.service.EdificioService;
import it.lorenzoDeCarolis.GestionePrenotazioni.service.PostazioneService;
import it.lorenzoDeCarolis.GestionePrenotazioni.service.PrenotazioneService;
import it.lorenzoDeCarolis.GestionePrenotazioni.service.UtenteService;
...
//		popolaDB();
	...
	public void popolaDB() {
		...
		Edificio ed1 = inserisciEdificio("A", "Via Mela,10", "Roma");
		Edificio ed2 = inserisciEdificio("B", "Via Pera,8", "Roma");
		Edificio ed3 = inserisciEdificio("C", "Via Melone,15", "Milano");

		Utente u1 = inserisciUtente("Pippo", "Mario", "Rossi", "m@rossi.it");
		Utente u2 = inserisciUtente("Pluto", "Luca", "Verdi", "l@verdi.it");
		Utente u3 = inserisciUtente("Paperina", "Anna", "Bianchi", "a@bianchi.it");
