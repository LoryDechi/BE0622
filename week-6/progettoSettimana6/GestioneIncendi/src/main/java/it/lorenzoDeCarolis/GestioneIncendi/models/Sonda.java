package it.lorenzoDeCarolis.GestioneIncendi.models;

import java.util.ArrayList;
import java.util.List;

import it.lorenzoDeCarolis.GestioneIncendi.interfaces.Observer;
import it.lorenzoDeCarolis.GestioneIncendi.interfaces.Subject;
